...
| 2026-06-06 | prp3_savgol_submit | LightGBM (R1, 18 features) + Savgol w=31 p=2 | Post-processing: per-well Savgol smoothing | OOF `14.2123` vs raw `14.2187` (−0.0064) | PENDING `53428554` | Kernel `00-rogii-inference-r1` v8, offline, `--savgol-smooth` | Savgol ON confirmed in Kaggle log. Submission rows: 14151. TVT range: [11590.8, 12238.1]. Awaiting LB score. |
